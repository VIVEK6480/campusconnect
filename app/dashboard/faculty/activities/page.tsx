    ...
    <div className="min-h-screen w-full overflow-x-hidden bg-[#edf4fa] text-[#0d1728]">
              ...
              <div className="relative z-10 flex h-full flex-col justify-between gap-8 lg:flex-row lg:items-center lg:gap-10">
                <div className="max-w-3xl">
                  ...
                  <p className="mt-3 max-w-2xl text-sm leading-6 text-blue-100/90 sm:text-base">
                    Create and manage campus activities that appear directly in the existing Student Activities panel.
                  </p>
                </div>
              ...
              <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div className="relative w-full lg:max-w-2xl">
                  ...
                  <input
                    ...
                    className="h-11 w-full rounded-xl border border-[#d8e5ec] bg-[#f7fbfd] pl-10 pr-4 text-sm font-medium text-[#344e60] outline-none transition placeholder:text-[#91a3ae] focus:border-[#54bce5] focus:bg-white focus:ring-4 focus:ring-[#54bce5]/10"
                  />
                </div>
              ...
              {loading ? (
                ...
                <div className="rounded-3xl border border-dashed border-[#b9d1db] bg-white px-6 py-20 text-center shadow-sm">
                  ...
                  <p className="mx-auto mt-2 max-w-xl text-sm leading-6 text-[#718895]">
                    Create your first activity from the button above. Once saved, it will use the same Activity table and appear on the existing Student Activities page.
                  </p>
                  <button
                    type="button"
                    onClick={openCreateModal}
                ...
                <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
                  {filteredActivities.map((activity) => {
                    ...
                    return (
                      <article
                        key={activity.id}
                        className={`faculty-activity-card group relative flex min-h-[365px] flex-col overflow-hidden rounded-[24px] border bg-white shadow-sm transition-all duration-300 ${
                          isPast ? "border-[#d8e3ed]" : "border-[#c6e7f0]"
                        }`}
                      >
                        {/* TOP ACCENT */}
      ...
      <style jsx>{`
        ...
        .faculty-activity-card::before {
          ...
          box-shadow: inset 0 0 0 1px rgba(84,188,229,.08);
        ...
        .faculty-activity-card:focus-within {
          ...
          border-color: rgba(84,188,229,.55) !important;
          background: #fbfdfe;
          box-shadow:
            0 16px 34px rgba(15,23,42,.10),
            0 0 0 1px rgba(84,188,229,.10),
            0 0 26px rgba(84,188,229,.20),
            0 0 54px rgba(59,130,246,.08);
          z-index: 10;
        }
        ...
        .faculty-activity-card:hover .faculty-mini-box:not(.faculty-time-box),
        .faculty-activity-card:focus-within .faculty-mini-box:not(.faculty-time-box) {
          transform: translate3d(0,-3px,0) scale(1.045);
          border-color: rgba(84,188,229,.80) !important;
          background: linear-gradient(
            112deg,
            #0f3146 0%,
            #185b79 52%,
          ...
          box-shadow:
            ...
            0 0 0 1px rgba(84,188,229,.16),
            0 0 18px rgba(84,188,229,.28),
        ...
        .faculty-activity-card:hover .faculty-mini-box > *,
        .faculty-activity-card:focus-within .faculty-mini-box > * {
          color: #ffffff !important;
    ...
    <div
      ...
      style={{
        ...
        borderColor: hovered
          ? "rgba(84,188,229,.48)"
          : "rgb(216 227 237)",
        background: hovered ? "#fbfdff" : "#ffffff",
        boxShadow: hovered
    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: "inset 0 0 0 1px rgba(84,188,229,.08)",
          transition: "opacity 220ms ease",
        }}
      />
