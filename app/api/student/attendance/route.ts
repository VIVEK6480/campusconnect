      ...
      return NextResponse.json(
        {
          success: false,
          message:
            "Only students can access this attendance page.",
        },
        { status: 403 }
      );
    }
